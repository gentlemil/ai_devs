  ...
  schema: {
    ...
    properties: {
      ...
      skills: {
        ...
        items: { type: "string" },
        description:
          "List of skills, technologies, or competencies. Empty array if none mentioned.",
      },
    },
...
async function main() {
  const text =
    "John is 30 years old and works as a software engineer. He is skilled in JavaScript, Python, and React.";
  ...
  console.log(
    "Skills:",
    person.skills.length ? person.skills.join(", ") : "none",
  );
}
